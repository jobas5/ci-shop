					...
					<div class="card mb-3">
						<div class="card-body">
							...
							<span class="float-right">
								Urutkan harga: <a href="<?= base_url('shop/sortby/asc') ?>" class="badge badge-secondary">Termurah</a> | <a href="<?= base_url('shop/sortby/desc') ?>" class="badge badge-secondary">Termahal</a>
							</span>
						</div>
					</div>
				</div>
